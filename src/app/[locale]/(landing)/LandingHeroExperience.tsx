...
const copy = {
  en: {
    ...
    quotaHint: 'First layered edit free · no sign-up needed',
    socialProof: 'Controlled revisions with recoverable layers',
  ...
  zh: {
    ...
    loading: '加载中...',
    secondaryCta: '打开编辑器',
    quotaHint: '第一次完整分层修改免费 · 无需注册',
    socialProof: '可控修改，并保留可恢复图层',
