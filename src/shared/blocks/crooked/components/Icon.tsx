...
export const Icons = {
  CrookedLogo: () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 100 100">
      <rect x="20" y="20" width="60" height="60" rx="14" fill="#2563eb" transform="rotate(-8 50 50)"/>
      <rect x="35" y="35" width="30" height="30" rx="6" fill="white" transform="rotate(12 50 50)"/>
      <rect x="45" y="45" width="10" height="10" rx="2" fill="#2563eb" transform="rotate(-15 50 50)"/>
    </svg>
  ),
  Layer: () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m12.83 2.18a2 2 0 0 0-1.66 0L2.6 6.8a2 2 0 0 0 0 3.6l8.57 4.62a2 2 0 0 0 1.66 0l8.57-4.62a2 2 0 0 0 0-3.6Z"/><path d="m2.6 13.6 8.57 4.62a2 2 0 0 0 1.66 0l8.57-4.62"/><path d="m2.6 18.4 8.57 4.62a2 2 0 0 0 1.66 0l8.57-4.62"/></svg>
  ),
  Eye: () => (
  ...
  Colors: () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="13.5" cy="6.5" r=".5" fill="currentColor"/><circle cx="17.5" cy="10.5" r=".5" fill="currentColor"/><circle cx="8.5" cy="7.5" r=".5" fill="currentColor"/><circle cx="6.5" cy="12.5" r=".5" fill="currentColor"/><path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c.92 0 1.7-.72 1.7-1.64 0-.44-.17-.85-.45-1.15l-.04-.04c-.33-.35-.51-.81-.51-1.27 0-.94.76-1.7 1.7-1.7h1.9c3.15 0 5.7-2.55 5.7-5.7 0-4.75-4.48-8.5-10-8.5Z"/></svg>
  ),
  Magic: () => (
