...
export async function getSettings() {
  ...
  "premium-yearly": "prod_xxx"
    ...
    },
    {
      ...
      type: 'text',
      value: 'fal-ai/qwen-image-layered',
      placeholder: 'fal-ai/qwen-image-layered',
      group: 'fal',
      tab: 'ai',
    ...
    },
    {
      ...
      type: 'text',
      value: 'openai/gpt-image-2/edit',
      placeholder: 'openai/gpt-image-2/edit',
      group: 'fal',
      tab: 'ai',
      tip: 'Default fal.ai image editing endpoint used for selected layers',
    },
    {
      name: 'gemini_api_key',
