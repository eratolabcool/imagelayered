...
export async function getSettings() {
  ...
  "premium-yearly": "prod_xxx"
    ...
    {
      name: 'layer_decomposition_provider',
      title: 'Layer Decomposition Provider',
      type: 'text',
      value: 'kie',
      placeholder: 'kie',
      group: 'kie',
      tab: 'ai',
      tip: 'Provider used for automatic poster layer decomposition',
    },
    {
      name: 'layer_decomposition_model',
      title: 'Layer Decomposition Model',
      type: 'text',
      value: 'seedream/5-pro-layer-decomposition',
      placeholder: 'seedream/5-pro-layer-decomposition',
      group: 'kie',
      tab: 'ai',
      tip: 'Model used to split posters into editable layers',
    },
    {
      name: 'poster_edit_provider',
      title: 'Poster Edit Provider',
      type: 'text',
      value: 'fal',
      placeholder: 'fal',
      group: 'fal',
      tab: 'ai',
      tip: 'Provider used after decomposition for high-quality layer editing',
    },
    {
      name: 'poster_edit_model',
      title: 'Poster Edit Model',
      type: 'text',
      value: 'bytedance/seedream/v5/pro/edit',
      placeholder: 'bytedance/seedream/v5/pro/edit',
      group: 'fal',
      tab: 'ai',
      tip: 'Internal image editing capability used for selected layers',
    },
    {
      name: 'gemini_api_key',
